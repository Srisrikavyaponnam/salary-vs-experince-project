...
with st.container():
 st.subheader("Hi, I am srikavya :wave:")
 st.write("[linkedin Profile](https://www.linkedin.com/in/ponnam-srikavya-datascientist)")
 st.write("[ Github website](https://github.com/Srisrikavyaponnam)")
...
Year Experience: How many years of experience
...
st.image("salary img.jpg",width = 800)
